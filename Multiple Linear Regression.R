...
sqrt(mean((final_data1$error1)^2))->rsme1
rsme1
...
class(final_data2)
as.data.frame(final_data2)->final_data3
class(final_data3)

final_data3$Actual-final_data3$Predicted->error2
View(error2)

cbind(final_data3,error2)->final_data3
View(final_data3)

sqrt(mean((final_data3$error2)^2))
...
class(final_data4)
as.data.frame(final_data4)->final_data5
class(final_data5)

final_data5$Actual - final_data5$Predicted->error3
View(error3)
cbind(final_data5,error3)->final_data5
View(final_data5)

sqrt(mean((final_data5$error3)^2))
